...
export default function Confianza() {
  return (
    <div className="mt-8 pl-4">
      <h3 className="font-bold text-xl border-b-4 border-indigo-500 pb-2 pr-4 inline-block">Confianza</h3>
      ...
      <motion.div className="mt-6">
        ...
        <p>
          Esperanza firme que se tiene en alguien o algo.
        </p>
      </motion.div>
      ...
      <motion.div className="mt-6 w-full flex flex-col rounded-lg text-left 
        ...
        <p className="italic pl-8 mt-2">
          “Nuestro problema es que, como sabemos que Dios puede hacer cualquier cosa, queremos que Él lo haga todo.”
        </p>
      </motion.div>
    </div>
  );

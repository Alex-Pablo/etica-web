...
export default function Sabiduria() {
  return (
    <div className="mt-8 pl-4">
      <h3 className="font-bold text-xl border-b-4 border-indigo-500 pb-2 pr-4 inline-block">Sabiduría</h3>
      ...
      <motion.div className="block mt-6
        ...
        <p className="text-base italic font-semibold">
          Si alguno de vosotros tiene falta de sabiduría, pídala a Dios, quien da a todos abundantemente.

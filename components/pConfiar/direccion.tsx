...
export default function Direccion() {
  return (
    <div className="mt-8 pl-4">
      <h3 className="font-bold text-xl border-b-4 border-indigo-500 pb-2 pr-4 inline-block">Dirección</h3>
      ...
      <motion.div className="mt-6 w-full flex flex-col rounded-lg text-left 
        ...
        <p className="italic pl-8 mt-2">
          “Te vuelves grande al ser dirigido por un buen instructor.”
        </p>
      </motion.div>
    </div>
  );

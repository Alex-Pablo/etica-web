...
export default function Sensatez() {
  return (
    <div className="mt-8 pl-4">
      <h3 className="font-bold text-xl border-b-4 border-indigo-500 pb-2 pr-4 inline-block">Sensatez</h3>
      ...
      <motion.div className="block mt-6
        ...
        <p className="text-base italic font-semibold">
          El que es prudente ve el peligro y lo evita, pero el insensato sigue adelante y sufre las consecuencias.
      ...
      <motion.div className="mt-6">
        ...
        <p>
          Cualidad de sensato (prudente, cuerdo).
        </p>
      </motion.div>
      ...
      <motion.div className="mt-6 w-full flex flex-col rounded-lg text-left 
        ...
        <p className="italic pl-8 mt-2">
          “En la soledad, el hombre sensato es el primero que cede siempre. Por eso, los más sabios son dirigidos por los más necios y extravagantes.”
          <span className="font-medium">Jean de la Bruyere</span>
        </p>
      </motion.div>
    </div>
  );

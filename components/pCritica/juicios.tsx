...
export default function Juicios() {
  return (
    <div className="mt-8 pl-4">
      <h3 className="font-bold text-xl border-b-4 border-indigo-500 pb-2 pr-4 inline-block">Juicios</h3>
      ...
      <motion.div className="mt-6 w-full flex flex-col rounded-lg text-left 
        ...
        <p className="italic pl-8 mt-2">
          “Si quieres saber cómo vivir la vida cristiana, le debes preguntar a un pecador, pues él puede ofrecerte algunas buenas observaciones.”
        </p>
      </motion.div>
